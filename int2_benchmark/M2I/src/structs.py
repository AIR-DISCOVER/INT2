...
class WaymoPred(Dict[Tuple[ScenarioID, ObjectID], MultiScoredTrajectory]):
    pass
...
class WaymoAutoregPred(Dict[Tuple[ScenarioID, ObjectID], AutoregStruct]):
    pass
