...
def parse_config():
    ...
    parser.add_argument('--interaction_scenario_path', type=str, default='int2_dataset_example/interaction_scenario/complete_scenario/0/010213250706-010213264206.pickle',
