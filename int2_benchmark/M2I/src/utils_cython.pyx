...
def _get_roads(decoded_example, normalizer, args):
    cdef:
        ...
        int i, j, k, this_id, now, lst, len_vectors = 0, max_point_num = 2500, polyline_num = 0, max_vector_num = 10000, max_lane_num = 20000
        int lane_id

        np.ndarray[np.float32_t, ndim=2] xyz = decoded_example['roadgraph_samples/xyz']
        # warning: dir need normalize
        np.ndarray[np.float32_t, ndim=2] dir = decoded_example['roadgraph_samples/dir']
        np.ndarray[int, ndim=1] type = decoded_example['roadgraph_samples/type'].reshape(-1).astype(np.int32)
        np.ndarray[int, ndim=1] valid = decoded_example['roadgraph_samples/valid'].reshape(-1).astype(np.int32)
        np.ndarray[int, ndim=1] id = decoded_example['roadgraph_samples/id'].reshape(-1).astype(np.int32)

        np.ndarray[np.float32_t, ndim=1] traffic_light_x = decoded_example['traffic_light_state/current/x'].reshape(-1)
        np.ndarray[np.float32_t, ndim=1] traffic_light_y = decoded_example['traffic_light_state/current/y'].reshape(-1)
        np.ndarray[int, ndim=1] traffic_light_state = decoded_example['traffic_light_state/current/state'].reshape(-1).astype(np.int32)
        np.ndarray[int, ndim=1] traffic_light_valid = decoded_example['traffic_light_state/current/valid'].reshape(-1).astype(np.int32)
        np.ndarray[int, ndim=1] traffic_light_id = decoded_example['traffic_light_state/current/id'].reshape(-1).astype(np.int32)
...
def _get_traffic_lights(decoded_example, normalizer, args):
    cdef:
        ...
        np.ndarray[np.float32_t, ndim=2] traffic_light_x = decoded_example['traffic_light_state/current/x']
        np.ndarray[np.float32_t, ndim=2] traffic_light_y = decoded_example['traffic_light_state/current/y']
        np.ndarray[int, ndim=2] traffic_light_state = decoded_example['traffic_light_state/current/state'].astype(np.int32)
        np.ndarray[int, ndim=2] traffic_light_valid = decoded_example['traffic_light_state/current/valid'].astype(np.int32)
        np.ndarray[int, ndim=2] traffic_light_id = decoded_example['traffic_light_state/current/id'].astype(np.int32)

        np.ndarray[np.float32_t, ndim=2] traffic_light_x_past = decoded_example['traffic_light_state/past/x']
        np.ndarray[np.float32_t, ndim=2] traffic_light_y_past = decoded_example['traffic_light_state/past/y']
        np.ndarray[int, ndim=2] traffic_light_state_past = decoded_example['traffic_light_state/past/state'].astype(np.int32)
        np.ndarray[int, ndim=2] traffic_light_valid_past = decoded_example['traffic_light_state/past/valid'].astype(np.int32)
        np.ndarray[int, ndim=2] traffic_light_id_past = decoded_example['traffic_light_state/past/id'].astype(np.int32)
